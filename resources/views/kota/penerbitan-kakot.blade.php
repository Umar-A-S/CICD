                ...
                <table class="w-full text-left border-collapse" id ="tablePerlu">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition text-sm text-black">
                            ...
                            <td class="px-6 py-4 max-w-[180px] truncate">{{ $item->daerah_asal }}</td>
                            <td class="px-6 py-4 max-w-[180px] truncate">{{ $item->nomor_surat }}</td>
                            <td class="px-6 py-4 text-center max-w-[180px] truncate">{{ $item->jenis_permohonan }}</td>
