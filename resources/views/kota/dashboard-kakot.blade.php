<x-layout-dashboard-kakot :stat="$stat"> 
                                    ...
                                    <tbody>
                                        @forelse($permohonans as $permohonan)
                                            <tr class="border-b border-gray-200 hover:bg-gray-50 transition" data-status="{{ strtolower($permohonan->status) }}">
                                                ...
                                                <td class="px-6 py-4">
                                                    <a href="/detail-permohonan/{{ $permohonan->id }}" class="text-blue-600 hover:text-blue-800 font-semibold">
                                                        Lihat Detail
                                                    </a>
                                                </td>
                                            </tr>
