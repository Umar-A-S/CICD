...
<head>
    ...
    <title>Permohonan Kota/Kabupaten</title>

    <script src="https://cdn.tailwindcss.com"></script>
    <link rel="stylesheet" href="https://rsms.me/inter/inter.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <link rel="stylesheet" href="css/style-permohonan-kakot.css">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<body class="flex h-screen overflow-hidden">
    ...
    <main class="md:ml-48 flex-1 flex flex-col relative overflow-hidden">
        ...
        <!-- HEADER -->
        <x-header-kakot>{{ $title }}</x-header-kakot>
    ...
    <!-- SCRIPT -->
    <script src="/js/permohonan-kakot.js"></script>
