...
<aside
    ...
    <nav class="flex-1 mt-4 px-2 space-y-1 overflow-y-auto">
        ...
        @if($role === 'kota')
            <x-nav-link href="/dashboard_kakot" icon="fa-solid fa-table-cells-large">
                Dashboard
            </x-nav-link>
            ...
            <x-nav-link href="/permohonan_kakot" icon="fa-solid fa-file">
                Permohonan
            </x-nav-link>
            ...
            <x-nav-link href="/profil_kakot" icon="fa-solid fa-user">
                Profil
            </x-nav-link>
        @endif
